...
train_path = r"D:\python\image-classification\dataset\train"
...
#f= open(output_path+'data.txt','w')
#f.write(str(np.array(rescaled_features)))
h5f_data = h5py.File(output_path+'data.h5', 'w')
h5f_data.create_dataset('dataset_1',data=np.array(rescaled_features))
#l=open(output_path+'labels.txt','w')
#l.write(str(np.array(target)))
